...
async function initDB() {
  ...
  try {
    ...
    const seedRooms = [
      [101,'1F','감정 층','작아지는 마음의 방','SNS나 타인의 성취를 본 뒤, 나를 비교하고 초라하게 느낄 때','{"emotions":["anxious","shrunk"]}','[{"name":"화면 내려놓기","guide":"화면을 내려놓고, 눈을 감아보세요. 지금 내 안에서 어떤 감각이 느껴지나요."},{"name":"그 느낌 바라보기","guide":"작아지는 느낌이 어디에서 오는지, 판단하지 말고 그냥 바라봐보세요."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로 적어보세요. 바꾸려 하지 않아도 괜찮아요."}]'],
      [102,'1F','감정 층','발바닥으로 돌아오는 방','걱정이 커져서 몸이 붕 뜨고, 지금 여기에 있지 않은 느낌이 들 때','{"emotions":["anxious","tense"]}','[{"name":"발바닥 착지","guide":"두 발이 바닥에 닿아 있는 걸 느껴보세요. 발바닥의 감각에 집중합니다."},{"name":"세 번 내쉬기","guide":"코로 4초 들이쉬고, 잠깐 멈추고, 입으로 6초 내쉬세요. 세 번."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로 적어보세요."}]'],
      [103,'1F','감정 층','힘이 들어간 곳의 방','화가 나거나 억울해서 턱, 어깨, 주먹 등에 힘이 들어갈 때','{"emotions":["irritated","tense"]}','[{"name":"힘이 간 곳 찾기","guide":"몸 어딘가에 힘이 들어가 있어요. 턱, 주먹, 어깨. 지금 그곳을 찾아보세요."},{"name":"쥐었다 펴기","guide":"두 손을 꽉 쥐고 5초. 그리고 천천히 펴보세요."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로 적어보세요."}]'],
      [104,'1F','감정 층','가라앉은 날의 방','특별한 이유 없이 기운이 없고, 마음이 아래로 가라앉을 때','{"emotions":["lethargic","lonely"]}','[{"name":"무거움 인정하기","guide":"오늘은 가라앉는 날이구나, 하고 한 번 인정해보세요."},{"name":"배 위에 손 올리기","guide":"편하게 누워서 배 위에 손을 올려보세요. 올라오고, 내려가고."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로 적어보세요."}]'],
      [105,'1F','감정 층','혼자인 것 같은 방','사람들 사이에 있어도 나만 동떨어진 것처럼 느껴질 때','{"emotions":["lonely","shrunk"]}','[{"name":"그 감각 찾기","guide":"혼자인 느낌이 몸 어디에 있는지 찾아보세요."},{"name":"나에게 말 건네기","guide":"조용히 괜찮아를 세 번 속으로 말해보세요."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로 적어보세요."}]'],
      [106,'1F','감정 층','자꾸 떠오르는 사람의 방','누군가의 말, 표정, 행동이 계속 생각나고 마음에 걸릴 때','{"emotions":["lonely","irritated"]}','[{"name":"질문 방향 바꾸기","guide":"그 사람은 왜 대신, 나는 어떤 마음으로 보고 있을까."},{"name":"내 상태 알아차리기","guide":"인정받고 싶은 건지, 서운한 건지, 그리운 건지."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로. 상대가 아닌 나에 대해."}]'],
      [107,'1F','감정 층','내려놓는 연습의 방','내가 바꿀 수 없는 일인데도 계속 붙잡고 신경 쓰일 때','{"emotions":["anxious","confused"]}','[{"name":"구분하기","guide":"지금 이 상황은, 내가 통제할 수 있는가?"},{"name":"인정하고 놓기","guide":"이건 내가 바꿀 수 없구나. 한 번 인정하고 내려놓기."},{"name":"한 문장 노팅","guide":"다음 스텝을 하나 선택해보세요. 그리고 적어보세요."}]'],
      [108,'1F','감정 층','굳어진 몸의 방','긴장해서 몸이 뻣뻣하고, 어깨·목·가슴에 힘이 들어갈 때','{"emotions":["tense","shrunk"]}','[{"name":"몸 훑어보기","guide":"머리부터 발끝까지 천천히 훑어보세요. 어디에 힘이 들어가 있나요?"},{"name":"어깨 내려놓기","guide":"어깨를 귀까지 올려 3초 유지, 툭 내려놓기. 세 번."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로 적어보세요."}]'],
      [201,'2F','공간 층','흔들리는 칸의 방','지하철이나 대중교통 안에서 잠깐 마음을 가라앉히고 싶을 때','{"places":["moving"]}','[{"name":"이어폰 빼기","guide":"지금 들리는 소리를 그냥 들어보세요. 그대로 두는 것."},{"name":"손가락 세기","guide":"손가락을 하나씩 천천히 접으며 다섯까지. 딱 그것만."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로 적어보세요."}]'],
      [202,'2F','공간 층','한 모금의 방','카페나 조용한 자리에서 감각을 천천히 되찾고 싶을 때','{"places":["cafe"]}','[{"name":"온기 느끼기","guide":"따뜻한 컵을 두 손으로 감싸보세요. 손바닥의 온기에 집중."},{"name":"한 모금 맛보기","guide":"한 모금 머금어보세요. 온도, 맛, 향. 조금 더 천천히."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로 적어보세요."}]'],
      [203,'2F','공간 층','숨이 좁아지는 자리의 방','사무실이나 책상 앞에서 답답하고 숨이 막히는 느낌이 들 때','{"places":["office"]}','[{"name":"눈 굴리기","guide":"눈을 감고 눈동자를 천천히 위아래로. 그게 시작이에요."},{"name":"세 번 깊은 숨","guide":"코로 4초, 멈추고, 입으로 6초. 세 번."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로 적어보세요."}]'],
      [204,'2F','공간 층','멈춰 서는 길의 방','걷는 중에 생각이 많아져서 잠시 감각으로 돌아오고 싶을 때','{"places":["outside"]}','[{"name":"발바닥 느끼기","guide":"발바닥에 전해지는 감각. 딱딱한지, 부드러운지. 지금 여기에 착지."},{"name":"하늘 올려다보기","guide":"잠깐 멈춰서 하늘을 올려다보세요. 구름의 모양, 움직임."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로 적어보세요."}]'],
      [205,'2F','공간 층','이불 속의 방','침대나 이불 속에서 나오기 싫고 몸이 무겁게 느껴질 때','{"places":["home"]}','[{"name":"이불 감촉 느끼기","guide":"이불이 피부에 닿는 감촉. 부드러운지, 따뜻한지."},{"name":"배 위에 손","guide":"배 위에 손을 올리고, 올라오고 내려가는 걸 느끼기."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로. 나오기 싫어도 괜찮아요."}]'],
      [206,'2F','공간 층','첫 한입의 방','밥을 먹고 있지만 맛을 잘 못 느끼거나 무심하게 먹고 있을 때','{"places":["home","cafe"]}','[{"name":"첫 한 입 느끼기","guide":"다음 한 입을 천천히. 씹는 소리, 식감, 온도."},{"name":"향 알아차리기","guide":"접시 위 음식의 향을 한 번 맡아보세요."},{"name":"한 문장 노팅","guide":"오늘 식사에서 가장 기억나는 감각을 한 문장으로."}]'],
      [207,'2F','공간 층','나를 마주보는 방','거울 속 내 모습이 낯설거나, 자꾸 평가하게 될 때','{"places":["home"]}','[{"name":"판단 멈추기","guide":"좋다 나쁘다 없이 그냥 바라봐보세요. 3초간."},{"name":"한 단어로 표현하기","guide":"지금 어떤 마음으로 나를 보고 있을까? 단어 하나만."},{"name":"한 문장 노팅","guide":"그 단어를 포함해서 한 문장을 적어보세요."}]'],
      [301,'3F','시간 층','잠들지 못한 새벽의 방','새벽에 깨어 있고, 생각이 많아 다시 잠들기 어려울 때','{"times":[1,3]}','[{"name":"생각 흘려보내기","guide":"머릿속 생각을 구름이라고 상상해보세요. 지나가는 걸 지켜봐보세요."},{"name":"호흡 세기","guide":"들숨과 날숨을 하나씩 세기. 열까지 세면 다시 처음부터."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로. 잠이 안 와도 괜찮아요."}]'],
      [302,'3F','시간 층','발이 무거운 아침의 방','출근길이나 하루 시작 전, 몸과 마음이 무겁게 느껴질 때','{"times":[1]}','[{"name":"한 발씩 착지","guide":"발바닥이 땅에 닿는 감각. 한 발, 한 발. 지금 여기에 착지."},{"name":"세 가지 소리","guide":"이어폰을 빼고, 들리는 소리를 세 가지만."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로 적어보세요."}]'],
      [303,'3F','시간 층','멈추지 않는 머릿속의 방','잠들기 전인데 머릿속 생각이 계속 이어질 때','{"times":[3,5]}','[{"name":"감사 하나","guide":"오늘 감사한 것 하나만. 작은 것 하나면 충분합니다."},{"name":"몸 이완하기","guide":"발끝부터 머리까지 힘을 빼보세요. 이불의 감촉, 베개의 온도."},{"name":"한 문장 노팅","guide":"오늘 하루를 한 문장으로 마무리해보세요."}]'],
      [304,'3F','시간 층','오늘을 내려놓는 방','퇴근길이나 하루 끝에, 아직 긴장과 생각이 남아 있을 때','{"times":[1,3]}','[{"name":"좋았던 감각 하나","guide":"아주 작아도 괜찮아요. 오늘 좋았던 감각 하나."},{"name":"바람 느끼기","guide":"얼굴에 닿는 바람. 방향, 온도. 알아차려보는 것."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로 적어보세요."}]'],
      [305,'3F','시간 층','아무것도 안 해도 되는 방','계획 없는 시간이 어색하고, 쉬어도 되는지 잘 모르겠을 때','{"times":[3,5]}','[{"name":"아무것도 안 하기","guide":"1분간 아무것도 하지 않아보세요. 그냥 있어보세요."},{"name":"감각 하나 찾기","guide":"가장 먼저 느껴지는 감각 하나. 소리, 빛, 온도, 촉감."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로 적어보세요."}]'],
      [306,'3F','시간 층','나른해지는 오후의 방','점심 후 몸이 처지고, 집중력과 에너지가 떨어질 때','{"times":[1]}','[{"name":"초록색 세 가지","guide":"초록색을 세 가지 찾아보세요. 찾는 동안 잠시 고요해져요."},{"name":"어깨 내려놓기","guide":"어깨가 올라가 있다면 살짝 내려놓아보세요."},{"name":"한 문장 노팅","guide":"지금 떠오르는 것을 한 문장으로 적어보세요."}]'],
      [307,'3F','시간 층','다시 시작되는 방','월요일 아침이나 새로운 시작 앞에서 부담이 올라올 때','{"times":[1,3]}','[{"name":"세 번 깊은 숨","guide":"코로 4초, 멈추고, 입으로 6초. 한 주 시작 전에, 잠시."},{"name":"내 상태 한 단어","guide":"지금 마음 상태를 단어 하나로. 바꾸려 하지 않아도 괜찮아요."},{"name":"한 문장 노팅","guide":"그 단어를 포함해서 한 문장을. 알아차리는 것이 시작이에요."}]'],
    ];
